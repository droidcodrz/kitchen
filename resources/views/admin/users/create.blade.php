            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="phone_number" name="phone_number" type="tel" pattern="^(\+91[\-\s]?)?[6-9]\d{9}$" maxlength="13" placeholder="9876543210" class="mt-1 block w-full" :value="old('phone_number')" />
