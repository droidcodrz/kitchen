<x-app-layout>
    <x-slot name="title">Add Custom Field</x-slot>
    ...
    <div class="bg-white dark:bg-gray-900 shadow-sm rounded-lg p-6 max-w-2xl" x-data="{ fieldType: '{{ old('field_type', 'text') }}', entityType: '{{ old('entity_type', 'product') }}' }">
