    ...
    <div class="bg-white dark:bg-gray-900 shadow-sm rounded-lg">
        <form method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data" class="p-6 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name')" required autofocus placeholder="Enter project name" />
            ...
            <div x-data="{
                ...
                <div class="mb-2 p-2 bg-yellow-100 dark:bg-yellow-900 text-sm">
                    Debug: Available Products Count: {{ isset($products) ? count($products) : 'Variable not set' }}
                </div>
