        ...
        <form method="POST" action="{{ route('products.update', $product) }}" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">If entered, this replaces the auto-generated description above. Includes any suffix that was added when this product was created - edit it directly here.</p>
