                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <a href="{{ route('products.show', $product) }}" class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300" title="View">
                                            ...
                                            <x-confirm-delete
                                                ...
                                                :disabled="($product->active_projects_count ?? 0) > 0"
                                                disabledReason="In use by {{ $product->active_projects_count ?? 0 }} active project(s) - cannot be deleted."
            ...
            @forelse (($products ?? collect()) as $product)
                <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200 dark:border-gray-800">
                        ...
                        <div class="flex items-center gap-2">
                            <a href="{{ route('products.show', $product) }}" class="icon-btn" title="View">
