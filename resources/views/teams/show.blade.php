<x-app-layout>
    <x-slot name="title">Team Details</x-slot>
                ...
                <form method="POST" action="{{ route('teams.members.store', $team) }}" class="mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                    ...
                    <div class="flex items-end gap-3">
                        <div class="flex-1">
                            ...
                            <select id="user_id" name="user_id" required class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
