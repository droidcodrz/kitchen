    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 shadow-sm rounded-lg p-6 border border-red-200 dark:border-red-800">
                ...
                @php $activeProjects = $inventoryItem->activeProjectsCount(); @endphp
                <x-confirm-delete :action="route('inventory.destroy', $inventoryItem)"
                    ...
                    disabledReason="{{ $activeProjects }} active project(s) depend on this item - cannot be deleted.">
