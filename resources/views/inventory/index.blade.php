<x-app-layout>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <x-confirm-delete
                                            ...
                                            :disabled="(($item->direct_active_count ?? 0) + ($item->bom_active_count ?? 0)) > 0"
                                            disabledReason="Active projects still depend on this item - cannot be deleted."
    ...
    <x-modal name="add-material" :show="$errors->any()" maxWidth="4xl">
